...
namespace MaterialSkin.Controls {
    public class MaterialForm : Form, IMaterialControl {
        ...
        public MaterialForm() {
            ...
            xHoverBrush = new SolidBrush(Color.FromArgb(255, 100, 100));
        ...
        private const int STATUS_BAR_HEIGHT = 30;
        ...
        protected override void OnPaint(PaintEventArgs e) {
            ...
            if (buttonState == ButtonState.XOver && ControlBox)
                g.FillRectangle(xHoverBrush, xButtonBounds);
            ...
            if (showIcon)
                g.DrawImage(new Bitmap(Icon.ToBitmap(), new Size(26, 26)), new Point(2, 2));
