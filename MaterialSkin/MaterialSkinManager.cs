...
namespace MaterialSkin
{
    public class MaterialSkinManager
    {
        ...
        public Brush GetRaisedButtonTextBrush(bool primary, bool lightFont = true)
        {
            return (primary && lightFont ? RAISED_BUTTON_TEXT_LIGHT_BRUSH : RAISED_BUTTON_TEXT_DARK_BRUSH);
        }
